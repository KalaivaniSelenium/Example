...
@Then("The User observe the campaign prospect count")
public void campaign_prospect_count() throws InterruptedException {
	campaigns.campaign_prospect_validation();
}
