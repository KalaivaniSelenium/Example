...
//		WebUI.clickElementWithJs(By.xpath("(//span[@class='icon'])[6]"));
	...
	public void campaign_prospect_validation()throws InterruptedException {
//		wait.until(ExpectedConditions.textToBePrese(By.xpath(FrameworkConstants.PROSPECT_COUNT_VALIDATION), 100));
		Thread.sleep(60000);
		
		Assert.assertEquals(WebUI.getTextElement(By.xpath(FrameworkConstants.PROSPECT_COUNT_VALIDATION)),"100");
